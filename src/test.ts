...
const runTest = async () => {
  ...
  // await loyalty.getLocationsByPosition(-2.394446, 53.522561).then(console.log).catch(console.error);

  // await loyalty
  //   .createCard({ userId: 'TESTUSER', cardNumber: '4444000000004002', expiryMonth: 10, expiryYear: 2025 })
  //   .then(console.log)
  //   .catch(console.error);
